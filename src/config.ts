/**
 * Configuration for Obsidian Telegram Assistant.
 *
...
console.log(
  `Config loaded: ${ALLOWED_USERS.length} allowed users, working dir: ${WORKING_DIR}, vault dir: ${VAULT_DIR}, timezone: ${VAULT_TIMEZONE}`
);
